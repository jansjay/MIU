...
public class G8LibraryMemberOverviewWindow2 extends G8PanelOverview implements G8Navigatable{
	/**
	 * 
	 */
	 ...
	 */
	public G8LibraryMemberOverviewWindow2(String title) {
		this();
		this.setTitle(title);
	}
	public G8LibraryMemberOverviewWindow2() {
